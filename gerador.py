...
class GeradorEgera:
    ...
    def adicionar_acento(self, silaba: str) -> str:
        ...
        """
        vogais_acentuadas = {"a": "á", "e": "é", "i": "í", "o": "ó", "u": "ú"}
    ...
    def validar_proparoxitona(self, palavra: str) -> bool:
        ...
        tem_acento_na_primeira = primeira_silaba is not None and any(
            c in primeira_silaba.group() for c in self.VOGAIS_ACENTUADAS
        )
...
def main() -> None:
    ...
    try:
        ...
        if quantidade > maximo:
            print(
                f"Erro: Você solicitou {quantidade:,} palavras, mas o máximo possível é {maximo:,}."
            )
